...
void CheckRegion::init(TbConfig &config) {
	...
	maskRad = config.cmdLineExtras_argGetter("B_CheckRegion_MaskingRadius", 1.5, "Radius in units of pixel pitch that will be employed for masking tracks in the vicinity of masked pixels");
